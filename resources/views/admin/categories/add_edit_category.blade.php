                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="parent_id">
                      ...
                      <option value="0"  @if($category['parent_id']==0) selected @endif>Main Categories</option>
                  ...
                  <div class="form-group">
                    ...
                    @if(!empty($category['category_image']))
                     <img style = "width:80px;"src= "{{asset('front/images/categories/'.$category['category_image'])}}">
                     <a href="{{url('admin/delete-category-image/'.$category['id'])}}"><i class="fas fa-trash"></i></a>
                    @endif
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    @if(!empty($category['description'])) value="{{$category['description']}}" @else value = "{{old('description')}}" @endif>
                  </div> 
                  <div class="form-group">
